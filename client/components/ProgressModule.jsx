...
export default class ProgressModule extends React.Component {
  ...
  getStudents_Assessments(assessment_id) {
    return (
      ...
      { id: 1, student_id: 1, assessment_id: 2, status_id: 3, evidence: 'evidence', date_modified: Date.now() },
      { id: 1, student_id: 1, assessment_id: 3, status_id: 2, evidence: 'evidence', date_modified: Date.now() },
      { id: 1, student_id: 1, assessment_id: 4, status_id: 1, evidence: 'evidence', date_modified: Date.now() },
      { id: 1, student_id: 1, assessment_id: 5, status_id: 2, evidence: 'evidence', date_modified: Date.now() },
      { id: 1, student_id: 1, assessment_id: 6, status_id: 1, evidence: 'evidence', date_modified: Date.now() }
    )
  }
